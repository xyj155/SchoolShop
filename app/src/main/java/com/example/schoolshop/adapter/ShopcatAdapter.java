...
public class ShopcatAdapter extends BaseExpandableListAdapter {
    ...
    public Object getChild(int groupPosition, int childPosition) {
        List<GoodGson.GoodsBean> childs = childrens.get(groups.get(groupPosition).getId());
     ...
     * @param child
     */
    private void showDialog(final int groupPosition, final int childPosition, final View showCountView,final  boolean isChecked, final  GoodGson.GoodsBean child) {
...
//                UtilTool.showKeyboard(mcontext,showCountView);
    ...
    private class GroupViewClick implements View.OnClickListener {
        private ShopGson group;
        private int groupPosition;
        private TextView editor;

        public GroupViewClick(ShopGson group, int groupPosition, TextView editor) {
            this.group = group;

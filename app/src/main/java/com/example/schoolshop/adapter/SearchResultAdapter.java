...
import com.example.schoolshop.ui.UserAddressEditorActivity;
        ...
        public void bindView(int position) {
            ...
            llLocation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, UserAddressEditorActivity.class);
                    intent.putExtra("location", textTitle.getText().toString());

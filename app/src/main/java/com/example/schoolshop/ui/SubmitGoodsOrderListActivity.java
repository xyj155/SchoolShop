...
public class SubmitGoodsOrderListActivity extends BaseActivity implements SubmitOrderListContract.View, UserSubmitOrderListContract.View {
    ...
    public int intiLayout() {
        return R.layout.activity_submit_goods_list_order;
    }
    ...
    public void initView() {
        ...
        ryOrder.setLayoutManager(new LinearLayoutManager(SubmitGoodsOrderListActivity.this));
        ryOrder.setAdapter(orderListAdapter);
    }

    @Override
    public void initData() {
        userSubmitOrderPresenter.getUserOrdersPayList("1", getIntent().getStringExtra("sid"));
    }
    ...
    @OnClick({R.id.rl_address, R.id.tv_choose, R.id.rl_post_free, R.id.rl_coupon, R.id.tv_pay})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_address:
                startActivityForResult(new Intent(SubmitGoodsOrderListActivity.this, UserAddressListActivity.class), 0xff);
                break;
            case R.id.tv_choose:
                startActivityForResult(new Intent(SubmitGoodsOrderListActivity.this, UserAddressListActivity.class), 0xff);
                break;
...
//        Glide.with(SubmitGoodsOrderListActivity.this).asBitmap().load(orderGson.getShop().getShop_cover()).into(ivShopCover);
...
//        Intent intent = new Intent(SubmitGoodsOrderListActivity.this, UserPaymentProcessActivity.class);
